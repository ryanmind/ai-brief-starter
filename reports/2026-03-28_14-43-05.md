...
### 4. Claude Code发布v2.1.86版本，新增会话ID头和文件排除功能
...
### 5. 通义千问代码版发布v0.0.14版本，支持计划模式和VL-Plus模型
