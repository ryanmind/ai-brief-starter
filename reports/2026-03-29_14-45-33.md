...
### 1. SteelantCNF/Smartphone-power-consumption-predictio
**摘要**：⭐ 2 stars | Python。
**关键点**
- ⭐ 2 stars | Python
...
### 5. shanfishapp/ErisPulse-KookAdapter:Kook 开黑啦 平台机器
...
### 6. ArpitaPaul2004/Route_optimizer 发布重要更新
**摘要**：⭐ 1 stars | Python。
**关键点**
- ⭐ 1 stars | Python
...
### 7. gsd-build/context-packet:File-based context resol
...
### 8. qdore/application-use:A native,blazingly fast ma
...
### 9. epcdiy/fileDeleter:美团删除用户照片复现程序
...
### 10. Anson-Trio/BaiShou-Next:用纯白誓约，守护彼此一生
...
### 11. monyhzc/ssecli:agentic native cli for ssemarket
...
### 12. pminhtaiii/btree-student-management 发布重要更新
...
### 13. drwoood/latexnav:LaTeX Navigator and Structure Su
...
### 14. egerev/claude-status-line:Rich status bar for Cla
...
### 15. CindyChen125/ResumAI 发布产品更新
...
### 16. brandonhimpfen/awesome-software-architecture:A cu
...
### 17. Dr-Wahab/nonlinear-pushover-analysis-of-a-2-bay-2
...
### 18. brandonhimpfen/awesome-mobile-app-architecture:A
...
### 19. brandonhimpfen/awesome-mobile-security:A curated
...
### 20. brandonhimpfen/awesome-android-development:A cura
