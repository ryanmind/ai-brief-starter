...
### 5. leobert-lan/MdToPdf:将单Md技术文档转换为单PDF，内嵌的Plantuml、M
...
### 6. daichanmark/claude-compact-setup:Claude Code hook
...
### 7. ThanatosXingYu/Hikvision-iSecureFucker:iSecueFuck
...
### 9. maxlory/lets-go-rss-workflow-publish 发布重要更新
**摘要**：⭐ 1 stars | Python。
**关键点**
- ⭐ 1 stars | Python
...
### 10. shuaibird/mcpplex:Terminal UI for exploring MCP l
...
### 11. ggabo-bug/learningPython:LEARNING
...
### 12. Nothing-dot-exe/Google-Chrome-Cache-Cleaners:A co
...
### 13. maxlory/jobmatch:JobMatch V1/P0 job management we
...
### 14. sazed5055/llmtest-perf:Production-quality perform
...
### 15. trinhtanphat/SLAPMAC 发布重要更新
**摘要**：⭐ 9 stars | Swift。
**关键点**
- ⭐ 9 stars | Swift
...
### 16. yudhaexe/claude-skill-job-resume-interview-prep 发布
**摘要**：⭐ 4 stars |。
**关键点**
- ⭐ 4 stars |
...
### 17. wqyinterest/-SFT-RL:以西游记中唐僧的对话数据对Qwen2.5-0.5B模型进行
...
### 18. lzjever/agentsmith-oss 发布重要更新
...
### 19. even813/midi-track-splitter:MIDI Track Splitter &
...
### 20. piwwing23/Pixel-Resolution-Premium-:Pixels Premiu
