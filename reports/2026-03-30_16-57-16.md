...
### 2. YukiKazahana/cadence:Cadence is a lightweight,st
...
### 3. Naveennaveentamil/ai-traffic-signal-optimization 发
**摘要**：⭐ 24 stars | Python。
**关键点**
- ⭐ 24 stars | Python
...
### 4. WillowHe/EvoOpt_oppangu_optimization_model:A set
...
### 5. Louis-zxLiu/ScholarPilot:ScholarPilot 是一个基于大语言模型
...
### 6. Codex-Pool/Codex-Pool:Self-hosted Codex/OpenAI co
...
### 7. apollosenvy/kernel-anvil:Profile-guided GPU kerne
...
### 8. linesoft2/tesla-fsd-can-mod-fork 发布重要更新
**摘要**：⭐ 9 stars | C++。
**关键点**
- ⭐ 9 stars | C++
...
### 9. sangwonme/ClaudeCode-Alert-Hook:Claude needs you.
...
### 10. Prijitha7/jalnetra-sih 发布重要更新
**摘要**：⭐ 10 stars | Dart。
**关键点**
- ⭐ 10 stars | Dart
...
### 11. mithra3003/ECommerce-Sales-Analysis:This project
...
### 12. itsPremkumar/Automated-Video-Generator 发布重要更新
...
### 13. AdityaHebballe/Game-Icon-Fixer 发布重要更新
**摘要**：⭐ 3 stars | Python。
**关键点**
- ⭐ 3 stars | Python
...
### 14. SakthiVarunishaa07/Expense-Tracker:Simple Python
...
### 15. titanwings/colleague-skill:你们搞大模型的就是码奸，你们已经害死前端兄弟
...
### 16. vladartym/always-fit-resume:A resume builder that
...
### 17. kepengxu/research-skills 发布重要更新
**摘要**：⭐ 3 stars | Python。
**关键点**
- ⭐ 3 stars | Python
...
### 18. AquaOne/ClawGuard:针对 OpenClaw 插件生态的自动化安全审计与防御系统
...
### 19. privatenumber/md-pen:Utilities for formatting Mar
...
### 20. Gokuld102/ai-traffic-signal-optimization:AI-based
